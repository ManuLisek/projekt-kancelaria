...
export const metadata: Metadata = {
  title: "Kontakt",
  description:
    "Skontaktuj się z kancelarią adwokacką. Sprawdź dane adresowe, telefon, email i mapę dojazdu.",
};
  ...
  return (
    <main>
      <section className="border-b border-white/10 bg-zinc-950 text-white">
        <div className="mx-auto w-full max-w-6xl px-6 py-16 sm:px-10">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-zinc-300">
            Wybierz najwygodniejszą formę kontaktu lub sprawdź lokalizację na
            mapie.
          </p>
        </div>
      </section>
      ...
      <section className="bg-zinc-950 text-white">
        <div className="mx-auto grid w-full max-w-6xl gap-10 px-6 py-16 sm:px-10 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="order-1 border border-white/10 bg-zinc-900 p-6 sm:p-8 lg:order-2">
            <h2 className="text-2xl font-semibold">{profile.officeName}</h2>

            <div className="mt-8 grid gap-6 text-zinc-300">
              {profile.address ? (
